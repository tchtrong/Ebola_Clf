...
#%%
#Records
sequences = [str(sequence.seq) for sequence in list(SeqIO.parse("fasta/all.fasta", "fasta"))]
...
#%%
freq_matrix_csv = pd.DataFrame(freq_matrix, index=[sequence for sequence in sequences], columns=(motifs))
...
#%%
freq_matrix_csv.to_csv("csv/freq_matrix.csv")
...
freq_matrix_without_X.to_csv("csv/freq_matrix_without_X.csv")
...
freq_matrix_with_X_less_than_half.to_csv("csv/freq_matrix_with_X_less_than_half.csv")
